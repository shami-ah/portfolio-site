    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="fixed bottom-20 right-4 md:right-6 z-40 group flex items-center justify-center w-11 h-11 rounded-full bg-accent/15 border border-accent/30 text-accent hover:bg-accent/25 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/15 transition-all duration-200 backdrop-blur-sm"
        >
