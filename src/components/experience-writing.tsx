  ...
  return [
    {
      ...
      points: [
        `Built and scaled OpenEvent to ${oe.clients}+ clients across ${oe.events}+ events`,
        "Automated event booking, CRM updates, and billing with AI",
      ],
      stack: [
        "React",
        "TypeScript",
    ...
    },
    {
      ...
      period: "2022 - 2024",
      points: [
        "Reduced manual data entry by 70% by introducing AI into daily operations",
        "Built a CRM that reduced the solar project lifecycle from 14 days to 5",
      ],
    ...
    },
    {
      ...
      period: "2023 - Present",
      points: [
        "Built AI automation solutions for clients across different industries",
        "Handle projects from initial idea and planning through final delivery",
      ],
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-6">
        ...
        <FadeUp>
          <div className="text-center mb-8 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">
              Where I&apos;ve worked.{" "}
              <span className="text-gradient">What I&apos;ve delivered.</span>
            </h2>
          </div>
        </FadeUp>
        ...
        <div className="md:hidden space-y-8">
            ...
            <div className="space-y-3">
                  ...
                  <TiltCard className="h-full">
                    <div className="card-glow card-gradient-border rounded-lg bg-card border border-card-border p-3 h-full flex flex-col font-mono hover:border-transparent transition-colors duration-300">
                      <div className="flex flex-wrap items-center gap-x-1.5 gap-y-0.5 mb-1.5 text-caption">
                        ...
                        <span className="px-1 py-px rounded bg-accent/10 text-accent border border-accent/20">
                          {role.branch}
                        </span>
                      ...
                      <div className="pl-2.5 border-l-2 border-card-border space-y-0.5 mb-2 flex-1">
                        {role.points.map((point) => (
                          <p
                            ...
                            className="text-caption text-muted leading-snug font-sans"
                          >
                            {point}
                          </p>
                        ))}
                      ...
                      {/* Client-friendly proof */}
                      <div className="flex items-center gap-2 text-caption text-muted/50 pt-1.5 border-t border-card-border/40">
                        <span>Delivery</span>
                        <span className="text-accent-status">
                          {role.stats.files} projects/features
                        </span>
                        <span className="ml-auto">Production work</span>
                      </div>
                    </div>
                  </TiltCard>
                </motion.div>
              ...
              <div className="flex flex-wrap items-center gap-1.5 mb-2">
                ...
                {["gogaa-cli", "codelens", "rasad"].map((branch) => (
                  <span
                    key={branch}
                    className="px-1.5 py-0.5 rounded text-[9px] font-mono bg-accent/5 text-accent/50 border border-accent/15"
                  >
                    {branch}
                  </span>
                ))}
          ...
          <div>
            ...
            <div className="space-y-3">
                  ...
                  <TiltCard className="h-full">
                    ...
                    >
                      ...
                      <h3 className="text-small font-bold font-sans mb-1.5 group-hover:text-accent transition-colors">
                        <span className="text-accent-secondary/30 font-normal">
                          #{" "}
                        </span>
                        {article.title}
                      </h3>
                      ...
                      <div className="pl-2.5 border-l-2 border-card-border mb-2 flex-1">
                        <p className="text-caption text-muted leading-snug font-sans line-clamp-3">
                          {article.summary}
                        </p>
                      </div>
                      ...
                      <div className="flex items-center gap-2 text-caption text-muted/50 pt-1.5 border-t border-card-border/40">
                        ...
                        <span className="ml-auto text-muted/30 group-hover:text-accent transition-colors">
                          Read article →
                        </span>
                      </div>
                    </Link>
              ...
              <Link
                href="/writing"
                className="inline-flex items-center gap-1.5 font-mono text-caption text-muted/40 hover:text-accent-secondary transition-colors"
              >
                View all articles →
              </Link>
            </div>
        ...
        <div className="hidden md:block">
          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 relative">
            ...
            {/* Row by row: experience left, writing right */}
            {roles.map((role, i) => {
              ...
              return (
                <React.Fragment key={role.hash}>
                  ...
                  >
                    ...
                    {/* Commit dot */}
                    <div
                      className={`absolute left-0 top-3 w-[16px] h-[16px] rounded-full border-[2.5px] bg-background z-10 ${
                        i === 0
                          ? "border-accent shadow-[0_0_6px_rgba(160,120,104,0.4)]"
                          : i === 1
            ...
            {/* Bottom row: more projects + view all */}
            <motion.div
              initial={false}
              animate={{ opacity: 1 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="text-caption font-mono text-muted/30">
                Initial Commit · 2019
              </div>
            </motion.div>
