...
export function HomeRoom(): React.ReactElement {
    ...
    >
      ...
      <div className="relative w-full max-w-4xl mx-auto px-5 md:px-6 text-center">
        ...
        >
          ...
          {/* 2. Description — word-by-word streaming (faster, no cursor) */}
          <p
            data-hero="desc"
          ...
          {/* 3. Compact stats strip — proof, not claims */}
          <motion.div
            data-hero="desc"
            initial={false}
            animate={{
          ...
          >
            <span className="text-foreground font-semibold">
              {status.portfolio.productionSystems}+{" "}
              <span className="text-muted/50 font-normal">systems shipped</span>
            </span>
            <span className="text-muted/20">/</span>
            <span className="text-foreground font-semibold">
              10 <span className="text-muted/50 font-normal">showcased</span>
            </span>
            <span className="text-muted/20">/</span>
            <span className="text-foreground font-semibold">
              {status.portfolio.yearsBuilding}+{" "}
              <span className="text-muted/50 font-normal">years</span>
            </span>
          </motion.div>
        </motion.div>

        {/* 4. Agent input container — AgentBar renders here via portal */}
        <motion.div
          id="hero-agent-mount"
          data-hero="agent"
          initial={false}
