...
export const projects: ProjectData[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    architecture: [
      ...
      "Pattern Scan (~430 patterns, 9 stacks)",
    ...
    features: [
      "~430 patterns mapped to real production failures, tagged with OWASP/CWE",
    ...
    techDecisions: [
      ...
      },
      {
        ...
        description: "430 deterministic patterns in <1s, then focused AI probes for semantic bugs no regex can catch. Coverage went from 8% to 100% on a head-to-head benchmark against a commercial AI reviewer.",
      },
    ],
    stack: ["TypeScript", "Docker", "esbuild", "Persistent JSON Index", "GitHub Actions", "GHCR"],
    results: [
      "~430 patterns across 9 stacks, validated against real production repos",
      "7-file PR review in 780ms, full 456-file PR in 12s",
      "Zero deps: single 351KB file, Docker image auto-published to GHCR",
      "Glean pipeline processed 600+ PRs, Agent Harvest added 34 patterns",
    ],
    ...
    vs: {
      mine: {
        title: "CodeLens",
        bullets: [
          "~430 patterns validated against real failures",
