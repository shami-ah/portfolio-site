...
export const projects: ProjectData[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    type: "AI Dev Tool",
    cardSummary: "544 patterns mined from 860+ production PRs. Reviews in under one second, entirely on your machine.",
    oneLiner: "544 bug patterns mined from 860+ real PRs. Under one second. Code never leaves your machine.",
    impact: "544 hand-crafted patterns mined from 860+ production PRs across 9 stacks. Reviews in under one second, entirely on your machine. When a commercial AI reviewer (Greptile) caught 12 issues CodeLens missed, I ran a gap analysis and closed every one — coverage went from 8% to 100%.",
    problem:
    ...
    architecture: [
      ...
      "Pattern Scan (~544 patterns, 9 stacks)",
    ...
    features: [
      "~544 patterns mapped to real production failures, tagged with OWASP/CWE",
    ...
    techDecisions: [
      ...
      },
      {
        ...
        description: "544 deterministic patterns in <1s, then focused AI probes for semantic bugs no regex can catch. Coverage went from 8% to 100% on a head-to-head benchmark against a commercial AI reviewer.",
      },
    ],
    stack: ["TypeScript", "Docker", "esbuild", "Persistent JSON Index", "GitHub Actions", "GHCR"],
    results: [
      "~544 patterns across 9 stacks, validated against real production repos",
      "7-file PR review in 780ms, full 456-file PR in 12s",
      "Zero deps: single 351KB file, Docker image auto-published to GHCR",
      "Glean pipeline processed 3,360+ PRs, Agent Harvest added 34 patterns, Greptile parity added 66",
    ],
    ...
    vs: {
      mine: {
        title: "CodeLens",
        bullets: [
          "~544 patterns validated against real failures",
