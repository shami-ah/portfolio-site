            ...
            <div className="flex flex-wrap gap-3">
              {project.live && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-accent/10 border border-accent/20 hover:border-accent/60 transition-all text-sm text-accent hover:text-foreground"
                >
              ...
              {project.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-card border border-card-border hover:border-accent/20 transition-all text-sm text-muted hover:text-foreground"
                >
